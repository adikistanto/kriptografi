<?php 
	...
	if(isset($_POST['enkrip'])){
		$teksori= $_POST['input'];//ambil plaintex
		$teks = str_ireplace(' ','',$teksori);
		$teks1='';$teks2='';$teks3='';//temporary baris
		$chiper='';
		$panjang = strlen($teks);
		$posit1= 0;
		$posit2= 1;
	...
	//======================== dekripsi ===================================
		...
		$chipori= $_POST['input'];//ambil plaintex
...
<html>
	<head>
		<title>zig-zag chiper</title>
	</head>
	<body bgcolor="#FDC9CF">
		<center>
			<h2>ZIG - ZAG Cipher</h2>
			<hr width="100%" size="5" color="#ED202D">
			<form method=POST action="proses.php">
				<textarea style="font-family: Helvetica;font-weight:bold; font-size:20px" name="input"><?php echo $hasil;?></textarea><br>
				<input type="submit" name="enkrip" value="enkrip"/>
				<input type="submit" name="dekrip" value="dekrip"/>
