...
<body>
 <form action="dekripproses.php" method=POST>
		<p><b>Masukkan Teks Yang akan di Dekripsi:</b></p>
				First name: <textarea type="text" name="chiper" onkeyup="dekripsi(this.value)"size="20" value=""><?php echo $chipertext;?></textarea>
				<p>Hasil Dekripsi (Plainteks) : <span id="txtHint"><?php echo $plaintext;?></span></p>
		<p><b>Masukkan Teks Yang akan di eNkripsi:</b></p>
				First name: <textarea type="text" name="plain" onkeyup="dekripsi(this.value)"size="20"><?php echo $teks;?></textarea>
				<p>Hasil Dekripsi (Plainteks) : <span id="txtHint"><?php echo $chiper;?></span></p>
		<a href="dekrip.html">reset</a>
	</form>	
